...
- **PTG Cord Umbilical Vein Study (University of Porto)** — supplementary anatomical material.

Full citations and DOI links are in the articles index.

---

## Course theory (supporting)

Lecture slides under `01_academic/04_reference_materials/02_course_material/` cover modalities, filtering, morphology, segmentation, and deep learning. See [Academic materials](academic.md#course-materials) for links.
