...
|-------|-------------------------|------------------------|-----------------|
| Segmentation core | [FetalVeinSegmentationUS.ipynb][ref-fetal] | [02_segmentation.ipynb][nb-segmentation] | `02_dataset/Save_Models/`, `results_*` |
| Post-processing & metrics | [Pos_Metrics.ipynb][ref-metrics] | [03_evaluation.ipynb][nb-evaluation] | `pos_process`, `calculate_metrics` |
...
2. [FetalVeinSegmentationUS.ipynb][ref-fetal] vs [02_segmentation.ipynb][nb-segmentation] — segmentation alignment  
3. [03_pipeline/README.md][pipeline-readme] — execution order  
